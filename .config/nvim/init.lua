...
--  TODO:: conflict with harpoon. Either change this to different key that doesn't conflict and as easy as this
--  or change harpoon keymap. THIS IS IMPORTANT
...
require('lazy').setup({
  ...
  { -- Autoformat
    ...
    keys = {
      ...
      --   '<leader>f',
      --   function()
      --     require('lua.custom.plugins.format').format_changed_lines()
      --   end,
      --   mode = '',
...
-- [[ END LAZY DEFAULT CONFIGURATION ]]
